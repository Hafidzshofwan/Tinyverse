      ...
      <div style={cardStyle} onClick={(e) => e.stopPropagation()}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
            <div>
              <label style={{ fontSize: "0.8rem", fontWeight: 700, color: "#334155" }}>Telepon / Kontak</label>
              <input
                type="text"
            ...
            <div>
              <label style={{ fontSize: "0.8rem", fontWeight: 700, color: "#334155" }}>Kota Faskes</label>
              <input
                type="text"
                value={config.kota}
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
            <div>
              <label style={{ fontSize: "0.8rem", fontWeight: 700, color: "#334155" }}>Nama Dokter DPJP</label>
              <input
                type="text"
            ...
            <div>
              <label style={{ fontSize: "0.8rem", fontWeight: 700, color: "#334155" }}>No. SIP Dokter</label>
              <input
                type="text"
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginTop: 20, paddingTop: 16, borderTop: "1px solid #E2E8F0" }}>
          ...
          <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
            {isSaved && <span style={{ fontSize: "0.8rem", color: "#16A34A", fontWeight: 700 }}>✓ Tersimpan!</span>}
            <button
              type="button"
              onClick={handleSave}
              style={{
