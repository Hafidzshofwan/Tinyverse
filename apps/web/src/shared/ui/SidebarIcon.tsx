...
export const PEMBELAJARAN_NAME_OPTIONS: ReadonlyArray<PembelajaranNameOption> = [
  {
    ...
    tagline: "Pusat Try Out UKNPDPD, Kasus Klinis & Kuis Interaktif",
    description: "Simulasi ujian CBT UKNPDPD, latihan MCQ modul, dan penalaran kasus nyata dengan pembahasan komprehensif dokter senior.",
    recommendation: "Pilihan ramah dan interaktif untuk mendampingi stase anak dan persiapan ujian dokter.",
  },
  {
    key: "akademi-klinis",
    label: "Akademi Klinis",
    badge: "Opsi 2 · Prestisius",
    tagline: "Pusat Uji Kompetensi & Kurikulum Pediatri",
    description: "Simulasi CBT berstandar nasional dan bank soal berbasis kompetensi SKDI untuk dokter muda, residen, maupun dokter spesialis.",
  ...
  },
  {
    ...
    tagline: "Simulasi Try Out, MCQ & Studi Kasus Step-by-Step",
    description: "Tiga pilar pembelajaran: Try Out CBT UKNPDPD, Uji Pemahaman MCQ per modul, dan Pembelajaran Berbasis Kasus nyata.",
