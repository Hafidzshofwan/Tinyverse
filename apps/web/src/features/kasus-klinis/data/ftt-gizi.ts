...
• Tidak ada riwayat diare kronis, tidak batuk >3 minggu`,
    ...
    },
    {
      ...
      pertanyaan: "Berdasarkan BB/U, status gizi Rani adalah?",
      opsi: [
        { id: "a", teks: "Gizi baik (Z-score BB/U antara -2 SD dan +2 SD)" },
        { id: "b", teks: "Gizi kurang (Z-score BB/U antara -3 SD dan -2 SD)" },
        { id: "c", teks: "Gizi buruk (Z-score BB/U < -3 SD)" },
        { id: "d", teks: "Underweight ringan (Z-score -1 SD)" },
      ],
      jawabanBenar: "b",
      penjelasan: "BB 7,0 kg: berada antara -3 SD (7,1 kg) dan -2 SD (8,2 kg). Z-score ≈ -2,9 SD → GIZI KURANG berat (borderline gizi buruk). Perlu penilaian BB/PB untuk menentukan wasting, dan PB/U untuk stunting.",
      linkKalkulator: { label: "Grafik Pertumbuhan WHO", href: "/preview/growth" },
    },
    {
      id: "ftt3",
      judul: "Penilaian Lengkap 3 Indikator",
      tipeInput: "mcq",
      narasi: "PB Rani = 74 cm. Rujukan WHO PB/U 18 bulan: Median = 80,7 cm | -2 SD = 76,0 cm | -3 SD = 72,8 cm. BB/PB 7,0 kg/74 cm: Z-score ≈ -1,5 SD (tidak ada wasting bermakna).",
      pertanyaan: "Profil gizi Rani yang paling akurat berdasarkan ketiga indikator adalah?",
      opsi: [
        { id: "a", teks: "Underweight + Stunting + tidak ada Wasting bermakna" },
        { id: "b", teks: "Underweight + Stunting — keduanya berat, perlu tatalaksana nutrisi segera" },
        { id: "c", teks: "Hanya Wasting berat, tinggi badan masih normal" },
        { id: "d", teks: "Semua normal — perbedaan tiap anak wajar" },
      ],
      jawabanBenar: "b",
      penjelasan: "BB/U: -2,9 SD → Underweight berat ✓. PB/U: 74 cm vs -2 SD = 76 cm → Z-score ≈ -2,6 SD → Stunting berat ✓. BB/PB: -1,5 SD → tidak ada wasting bermakna. Kombinasi underweight + stunting tanpa wasting = pola kronis (malnutrisi berlangsung lama). Ini BUKAN kasus akut.",
    },
    {
      id: "ftt4",
      judul: "Investigasi Penyebab",
      tipeInput: "mcq",
      narasi: "Profil gizi Rani: underweight berat + stunting, tanpa wasting bermakna. Tidak ada diare kronis, tidak batuk >3 minggu, tidak ada edema.",
    ...
    },
    {
      ...
      tipeInput: "numerik",
      narasi: "Rani didiagnosis malnutrisi kronik (stunting + underweight). BB saat ini 7,0 kg. Target kenaikan BB minimum fase rehabilitasi = 10 g/kgBB/hari.",
