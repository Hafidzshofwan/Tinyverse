...
/**
 * DaruratTool - island loader (port verbatim dari Tinyverse v17).
 *
 ...
 * (/darurat-tool.html) yang dimuat lewat <iframe>. Komponen ini hanya memuat island itu
 * dan menyesuaikan tinggi (auto-resize via postMessage).
 */
export function DaruratTool() {
  ...
  return <iframe src={useIslandSrc("/darurat-tool.html")} title="Mode Darurat" style={gaya} />;
}
