/**
 * Tabel rujukan Z-score WHO 0–60 bulan — DISALIN PERSIS dari
 * public/growth-tool.html (mesin v17). Tidak satu angka pun diubah.
 *
 * WHY tabel ini berdiri sendiri, tidak memakai tabel di longitudinal.ts:
 * tabel TB/U di longitudinal.ts hanya memuat 21 titik usia (interval 3 bulan)
 * dan beberapa nilainya berbeda pada desimal pertama dari tabel alat ini yang
 * memuat 61 titik usia (tiap bulan). Memakai ulang tabel tersebut akan
 * MENGUBAH hasil Z-score yang selama ini tampil di alat Kurva WHO & CDC.
 * Karena ini perangkat lunak medis, hasil plotting wajib identik dengan v17,
...
export const WHO_TBU_FEMALE_0_60: ZscoreTable = {
  ...
  58: [94.3, 99.0, 103.7, 108.4, 113.1, 117.7, 122.4],
  59: [94.7, 99.5, 104.2, 108.9, 113.6, 118.4, 123.1],
  60: [95.2, 99.9, 104.7, 109.4, 114.2, 119.0, 123.7],
};
...
/** Peta kunci `{standar}_{kelamin}_{indikator}_{kelompokUsia}` — persis seperti v17. */
export const TK_ZSCORE_TABLES: Record<string, ZscoreTable> = {
  "who_male_bbu_0-60": WHO_BBU_MALE_0_60,
  "who_female_bbu_0-60": WHO_BBU_FEMALE_0_60,
  "who_male_tbu_0-60": WHO_TBU_MALE_0_60,
