    ...
    <div style={wrapStyle}>
      <section className="tv-card tv-stack">
        ...
        <div style={actionsRow}>
          <button type="button" className="tv-btn" style={{ ...btnAuto, display: "inline-flex", alignItems: "center", gap: "6px" }} onClick={ambilProfil}>
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
              <path d="M21 12C21 16.9706 16.9706 21 12 21C7.02944 21 3 16.9706 3 12C3 7.02944 7.02944 3 12 3C15.302 3 18.1884 4.77802 19.7212 7.4208" stroke="#0284C7" strokeWidth="2.2" strokeLinecap="round"/>
              <path d="M21 3V8H16" stroke="#0284C7" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"/>
              <circle cx="12" cy="12" r="3" fill="#38BDF8"/>
            </svg>
            Ambil dari Profil
          </button>
          <button type="button" className="tv-btn" style={{ ...btnAuto, display: "inline-flex", alignItems: "center", gap: "6px" }} onClick={salin}>
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
              <rect x="8" y="7" width="11" height="13" rx="2" fill="#EDE9FE" stroke="#6D28D9" strokeWidth="1.8"/>
              <path d="M5 16H4C3.44772 16 3 15.5523 3 15V5C3 4.44772 3.44772 4 4 4H14C14.5523 4 15 4.44772 15 5V6" stroke="#8B5CF6" strokeWidth="1.8" strokeLinecap="round"/>
              <path d="M11 11H16M11 14H14" stroke="#6D28D9" strokeWidth="1.8" strokeLinecap="round"/>
            </svg>
            Salin
          </button>
          <button type="button" className="tv-btn" style={{ ...btnAuto, display: "inline-flex", alignItems: "center", gap: "6px" }} onClick={exportTxt}>
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
              <rect x="4" y="3" width="16" height="18" rx="3" fill="#ECFDF5" stroke="#059669" strokeWidth="1.8"/>
              <path d="M12 7V14M12 14L9 11M12 14L15 11" stroke="#047857" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
              <path d="M8 17H16" stroke="#10B981" strokeWidth="2" strokeLinecap="round"/>
            </svg>
            Export TXT
          </button>
          <button type="button" className="tv-btn" style={{ ...btnAuto, background: "#1E40AF", color: "#FFFFFF", display: "inline-flex", alignItems: "center", gap: "6px" }} onClick={cetak}>
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
              <path d="M6 9V4C6 3.44772 6.44772 3 7 3H17C17.5523 3 18 3.44772 18 4V9" stroke="#93C5FD" strokeWidth="1.8" fill="#3B82F6"/>
              <path d="M6 18H4C2.89543 18 2 17.1046 2 16V11C2 9.89543 2.89543 9 4 9H20C21.1046 9 22 9.89543 22 11V16C22 17.1046 21.1046 18 20 18H18" stroke="#FFFFFF" strokeWidth="1.8"/>
              <rect x="6" y="14" width="12" height="7" rx="1.5" fill="#FFFFFF" stroke="#60A5FA" strokeWidth="1.5"/>
              <path d="M9 17H15" stroke="#1E40AF" strokeWidth="1.6" strokeLinecap="round"/>
            </svg>
            Cetak PDF (Kop Surat)
          </button>
          <button type="button" className="tv-btn" style={{ ...btnAuto, display: "inline-flex", alignItems: "center", gap: "6px" }} onClick={() => setKopModalOpen(true)}>
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
              <circle cx="12" cy="12" r="3" fill="#F59E0B" stroke="#D97706" strokeWidth="1.5"/>
              <path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1 0 2.83 2 2 0 0 1-2.83 0l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-2 2 2 2 0 0 1-2-2v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83 0 2 2 0 0 1 0-2.83l.06-.06a1.65 1.65 0 0 0 .33-1.82 1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1-2-2 2 2 0 0 1 2-2h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 0-2.83 2 2 0 0 1 2.83 0l.06.06a1.65 1.65 0 0 0 1.82.33H9a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 2-2 2 2 0 0 1 2 2v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 0 2 2 0 0 1 0 2.83l-.06.06a1.65 1.65 0 0 0-.33 1.82V9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 2 2 2 2 0 0 1-2 2h-.09a1.65 1.65 0 0 0-1.51 1z" stroke="#D97706" strokeWidth="1.6" fill="#FEF3C7"/>
            </svg>
            Atur Kop Surat
          </button>
          <button type="button" className="tv-btn" style={{ ...btnAuto, display: "inline-flex", alignItems: "center", gap: "6px" }} onClick={bersihkan}>
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
              <path d="M3 6H5H21" stroke="#E11D48" strokeWidth="2" strokeLinecap="round"/>
              <path d="M8 6V4C8 3.44772 8.44772 3 9 3H15C15.5523 3 16 3.44772 16 4V6M19 6V20C19 20.5523 18.5523 21 18 21H6C5.44772 21 5 20.5523 5 20V6H19Z" fill="#FFE4E6" stroke="#E11D48" strokeWidth="1.8" strokeLinejoin="round"/>
              <path d="M10 11V17M14 11V17" stroke="#BE123C" strokeWidth="1.8" strokeLinecap="round"/>
            </svg>
            Bersihkan
          </button>
        </div>
