...
const DESKRIPSI: Record<string, string> = {
  ...
  "/preview/neonatus": "Dua alat neonatus dalam satu menu: TPN (GIR, asam amino, lipid) dan threshold bilirubin AAP 2022.",
